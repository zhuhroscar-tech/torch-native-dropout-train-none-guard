...
Ported verbatim (module-name-substituted) from the fleet's canonical
copy to close the same gap for this repo.
"""
...
from torch_native_dropout_train_none_guard import __version__
